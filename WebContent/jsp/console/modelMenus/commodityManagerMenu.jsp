...
<div id="container">
		<ul id="menu">
			<li id="menuitem"><a href="/SSH04/commodity_preadd.action" target="commodityManagerDisplay"><div name="item" id="item0" class="item"
					onMouseOver="javascript:itemHover(this)"
					onMouseOut="javascript:itemOut(this);"
					onClick="javascript:itemSelected(0);">添加商品</div></a></li>
            <li><div id="splitLine"></div></li>
			<li id="menuitem"><a href="../modelFunctions/showcommodity.jsp" target="commodityManagerDisplay"><div name="item" id="item1" class="item"
					onMouseOver="javascript:itemHover(this)"
					onMouseOut="javascript:itemOut(this);"
					onClick="javascript:itemSelected(1);">查看商品</div></a></li>
                     <li><div id="splitLine"></div></li>
