...
function checkForm(){
	...
	// 判断用户名是否填写
	var username = document.getElementById("adminacount");
	if(username.value == ""){
		alert("用户名必须填写！");
		return false;
	}
...
%>
<form id="form1" name="form1" method="post" action="admins_login" onSubmit="javascript:return checkForm();">
  <table id="loginTable" width="320">
    <tr>
      <td height="25" colspan="2"  class="title">管理员登录</td>
    </tr>
    <tr>
      <td width="83" height="25" align="right" valign="middle" class="text">登录帐号：</td>
      <td width="225"><label for="acount"></label>
      <input type="text" name="adminacount" id="adminacount" class="textStyle"></td>
    </tr>
    <tr>
      <td height="25" align="right" valign="middle" class="text">登录密码：</td>
      <td><label for="password"></label>
      <input type="password" name="adminpassword" id="adminpassword" class="textStyle"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="25" colspan="2" align="center" valign="middle"><input type="submit" name="btnLogin" id="btnLogin" value="立即登录" class="btn"></td>
    </tr>
  </table>
</form>
</body>
