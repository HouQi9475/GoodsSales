...
<body>
	...
	<div class="menu">
		<ul>
			...
			<li><a href="wishlist.html" class="wishlist">我的收藏</a></li>
			<li><a href="<%=basePath%>jsp/html/updateUsers.jsp"
				class="account">我的帐号</a></li>
	...
	<div style="width: 1000px; margin: 0 auto; margin-top: 10px;">
					...
					<s:if test="#items.size!=0">
						<s:iterator value="#items" id="item">
							<s:form action="updateCart" method="post" namespace="/"
								theme="simple">
								<tr>
									<td class="remove"><input type="checkbox" name="carts" id="carts"
										value="<s:property value="#request.commodity.commodityId" />" /></td>
									...
									<td><s:submit value="更新" /><br/><input type="button" value="删除" onclick="javascript:if(confirm('确定删除该项吗？')){location='/SSH04/deleteCart.action?commodityid=<s:property value="#request.commodity.commodityId" />'};"></td>
								</tr>
							</s:form>
						</s:iterator>
					</s:if>
		...
		<div class="buttons">
			<div class="left">
				<a class="button" style="width: 120px;" onclick="javascript:if(confirm('确定清空购物车吗？')){location='/SSH04/removeCart.action'}"><span>清空购物车</span></a>
			</div>
			<div class="right">
